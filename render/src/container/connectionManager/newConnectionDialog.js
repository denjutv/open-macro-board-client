...
({
    ...
    saveCurrentConnection: ( currentConnection, connections ) => checkConnectionConfig( currentConnection, connections ) ? dispatch( saveCurrentConnection( Object.assign( {}, currentConnection ), true ) ) : null
});
